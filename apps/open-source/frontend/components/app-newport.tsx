...
interface AppNewportProps {
  appConfig: AppConfig;
  livekitUrl?: string;
  apiUrl?: string;
}

export function AppNewport({ appConfig, livekitUrl, apiUrl }: AppNewportProps) {
  const [sessionStarted, setSessionStarted] = useState(false);
  const { connectionDetails, refreshConnectionDetails } = useConnectionDetailsNewport();
  ...
  return (
    <>
      <MotionWelcome
        key="welcome"
        startButtonText="Start Call with Pelican Petey"
